...
class Ui_Dialog_warner(object):
    ...
    def retranslateUi(self, Dialog_warner):
        ...
        Dialog_warner.setWindowTitle("历史记录界面")
        self.label_2.setText(_translate("Dialog_warner", "测试时间查找："))
        self.label.setText(_translate("Dialog_warner", "设备编号查找："))
        self.label_3.setText(_translate("Dialog_warner", "查询方式："))
        __sortingEnabled = self.listWidget.isSortingEnabled()
        self.listWidget.setSortingEnabled(False)
        item = self.listWidget.item(0)
        item.setText(_translate("Dialog_warner", "设备名称                 设备编号                    测试时间                                 测试人员   "))
        item = self.listWidget.item(1)
        item.setText(_translate("Dialog_warner", "1                                 1.1                          2020-12-2  10:10:10            小明"))
        item = self.listWidget.item(2)
        item.setText(_translate("Dialog_warner", "2                                 1.2                          2020-12-2  11:11:11            小明"))
        item = self.listWidget.item(3)
        item.setText(_translate("Dialog_warner", "3                                 1.3                          2020-12-3  12:10:10            小明"))
        item = self.listWidget.item(4)
        item.setText(_translate("Dialog_warner", "4                                 1.4                          2020-12-3  12:11:10            小明"))
        item = self.listWidget.item(5)
        item.setText(_translate("Dialog_warner", "5                                 1.5                          2020-12-3  12:12:10            小明"))
        item = self.listWidget.item(6)
        item.setText(_translate("Dialog_warner", "6                                 1.6                          2020-12-3  12:13:10            小明"))
